...
import 'package:ewastecare/features/store/screens/user/product_details/user_product_details.dart';
...
class WasteUserItemCardVertical extends StatelessWidget {
  const WasteUserItemCardVertical({super.key, required this.product});
