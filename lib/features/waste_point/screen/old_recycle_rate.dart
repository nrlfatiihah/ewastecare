...
class OldRecycleRate extends StatelessWidget {
  const OldRecycleRate({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Add ElevatedButton before the floatingActionButton
                      SizedBox(height: 20), // Add some space before the button
                      ElevatedButton(
                        onPressed: () async {
                          // Call the calculateMaterialWeights function or other actions
                          await adminDashboardService
                              .calculateMaterialWeights();

                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Material weights calculated!'),
                            ),
                          );
                        },
                        child: Text('Calculate Weights'),
                      ),
                    ],
                  ),
                ),
      ...
      floatingActionButton: const RateActionbutton(),
